...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:variable name="percentmultiplier" select="1000"/>
    
    <xsl:template match = "/">
        <xsl:result-document method="xhtml" indent="yes" href="../Site/percentage-graphs.html">
            <html>
                <head>
                ...
                <body>
                    ...
                    <h1>Emotion Percent Per Speech</h1>
                    <text>This Graph shows the percentage of emotions that make up each letter. (Graphs do not add up to 100% because not every sentence is tagged with an emotion)</text>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1500 6000">
                        <g transform="translate(250, 50)">
                            ...
                            <xsl:for-each select="$input">
                                ...
                                <xsl:variable name="happy" select="string-length(normalize-space(string-join(descendant::emotion[@mood = 'happy']))) div string-length(normalize-space(string-join(descendant::body)))*$percentmultiplier+20"/>
                                <xsl:variable name="sad" select="string-length(normalize-space(string-join(descendant::emotion[@mood = 'sad']))) div string-length(normalize-space(string-join(descendant::body)))*$percentmultiplier+20"/>
                                <xsl:variable name="angry" select="string-length(normalize-space(string-join(descendant::emotion[@mood = 'angry']))) div string-length(normalize-space(string-join(descendant::body)))*$percentmultiplier+20"/>
                                <xsl:variable name="bittersweet" select="string-length(normalize-space(string-join(descendant::emotion[@mood = 'bittersweet']))) div string-length(normalize-space(string-join(descendant::body)))*$percentmultiplier+20"/>
                                <xsl:variable name="hopeful" select="string-length(normalize-space(string-join(descendant::emotion[@mood = 'hopeful']))) div string-length(normalize-space(string-join(descendant::body)))*$percentmultiplier+20"/>
                                <xsl:variable name="afraid" select="string-length(normalize-space(string-join(descendant::emotion[@mood = 'afraid']))) div string-length(normalize-space(string-join(descendant::body)))*$percentmultiplier+20"/>
                                <xsl:variable name="disgusted" select="string-length(normalize-space(string-join(descendant::emotion[@mood = 'disgusted']))) div string-length(normalize-space(string-join(descendant::body)))*$percentmultiplier+20"/>
                                <xsl:variable name="hopeless" select="string-length(normalize-space(string-join(descendant::emotion[@mood = 'hopeless']))) div string-length(normalize-space(string-join(descendant::body)))*$percentmultiplier+20"/>
                                <xsl:variable name="triumphant" select="string-length(normalize-space(string-join(descendant::emotion[@mood = 'triumphant']))) div string-length(normalize-space(string-join(descendant::body)))*$percentmultiplier+20"/>
                                <xsl:variable name="defiant" select="string-length(normalize-space(string-join(descendant::emotion[@mood = 'defiant']))) div string-length(normalize-space(string-join(descendant::body)))*$percentmultiplier+20"/>
                                <xsl:variable name="defeated" select="string-length(normalize-space(string-join(descendant::emotion[@mood = 'defeated']))) div string-length(normalize-space(string-join(descendant::body)))*$percentmultiplier+20"/>
                                <xsl:variable name="yielding" select="string-length(normalize-space(string-join(descendant::emotion[@mood = 'yielding']))) div string-length(normalize-space(string-join(descendant::body)))*$percentmultiplier+20"/>
