...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="/"> <!--whc: you can call the variable anything; make sure it matches from the variable definition line to where you call for it-->
        ...
        <xsl:result-document method="xhtml" indent="yes" href="../Site/eori.html"> <!--whc: insert the correct file path and file name for your context-->
            ...
            <html>
                ...
                <body>
                    ...
                    </xsl:for-each> <!--whc: your xsl:apply-templates, xsl:for-each, etc. to create page content go here, the filepath starting with $input -->
                    <hr/>
                </body>
            </html>
